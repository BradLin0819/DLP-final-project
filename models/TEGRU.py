...
class TEGRU(nn.Module):
    def __init__(self, ntoken, d_model=512, 
            nhead=8, nhid=512, te_nlayers=6, te_dropout=0.5, 
            pretrained_vec=None, n_layers=2, bidirectional=True, 
            output_dim=1, hidden_dim=256, rnn_dropout=0.3, 
            pad_token_id=None
            ):
        ...
        self.rnn = nn.GRU(d_model, hidden_size=hidden_dim, 
        ...
        self.fc = nn.Linear(2 * rnn_input_dim if bidirectional else rnn_input_dim, output_dim)
